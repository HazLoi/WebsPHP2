                                    ...
                                    <form action="#" class="forgotten-password" method="post" id="customer-form">
                                        ...
                                        <div class="form-fields text-center ">
                                            <div class="form-group center-email-fields">
                                                <div class="email">
                                                    <input type="email" name="email" id="email" value="" class="form-control" placeholder="Email address" autocomplete="off">
                                                </div>
                                                <div>
                                            ...
                                            <a href="index.php?action=user-login" class="account-link">

                    ...
                    <div class="tiva-html col-lg-4 col-md-12 col-xs-12">
                        <div class="block">
                            <div class="block-content">
                                <p class="logo-footer">
                                    <img src="General/img/home/logo.png" alt="img">
                                </p>
                        ...
                        <div class="block">
                            <div class="block-content">
                                <p class="img-payment ">
                                    <img class="img-fluid" src="General/img/home/payment-footer.png" alt="img">
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="contact-us">
                                    ...
                                    <div class="content-contact address-contact">
                                        <p>123 Suspendis matti, Visaosang Building VST District NY Accums, North
                                            American</p>
                                    </div>
                                </div>
                                <div class="contact-us">
                            ...
                            <div class="block-content">
                                <div class="payment-content">
                                    ...
                                    <div class="payment-image">
                                        <img class="img-fluid" src="General/img/home/payment.png" alt="img">
                                    </div>
                                </div>
                                <!-- Popup newsletter -->
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="text-center col-lg-12 ">
                    <span>
                        <a target="_blank" href="index.php?action=https://www.templateshub.net">&copy; Web design by Ly Duc Loi</a>
                    </span>
                </div>
            </div>
        </div>
                ...
                <ul class="menu level1">
                    ...
                    <li class="item group-category-img parent group">
                        <a href="#" class="hasicon" title="TABLE LAMP">
                            <img src="General/img/home/table-lamp.png" alt="img">TABLE LAMP</a>
                ...
                <div id="megamenu" class="clearfix">
                    <ul class="menu level1">
                        <li class="item home-page has-sub">
                            ...
                            <a href="index.php?action=index" title="Home">
                                <i class="fa fa-home" aria-hidden="true"></i>Home</a>
                            <div class="subCategory collapse" id="home1" aria-expanded="true" role="status">
                                <ul>
                                    <li class="item">
                                        <a href="#" title="Home Page 1">Home Page 1</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Home Page 2">Home Page 2</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Home Page 3">Home Page 3</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Home Page 4">Home Page 4</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Home Page 5">Home Page 5</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="item has-sub">
                            ...
                            <div class="subCategory collapse" id="blog" aria-expanded="true" role="status">
                                <ul>
                                    <li class="item">
                                        <a href="index.php?action=blog-list-sidebar-left" title="Blog List (Sidebar Left)">Blog
                                            List (Sidebar Left)</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Blog List (Sidebar Left) 2">Blog List (Sidebar Left) 2</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Category Blog (Right column)">Blog List (Sidebar Right)</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Blog List (No Sidebar)">Blog List
                                            (No Sidebar)</a>
                                    </li>
                                    <li class="item">
                                        <a href="#" title="Blog Grid (No Sidebar)">Blog Grid
                                            (No Sidebar)</a>
                                    </li>
                                    <li class="item">
                                        <a href="index.php?action=blog-detail" title="Blog Detail">Blog Detail</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                            ...
                                            <ul>
                                                <li class="item col-md-4 ">
                                                    ...
                                                    <div class="menu-content">
                                                        <ul class="col">
                                                            <li>
                                                                <a href="index.php?action=shop">Product
                                                                    Grid (Sidebar Left)</a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Product
                                                ...
                                                <li class="item col-md-4 html">
                                                    ...
                                                    <div class="menu-content">
                                                        <ul>
                                                            <li>
                                                                <a href="index.php?action=product-detail">Product Detail
                                                                    (Sidebar Left)</a>
                                                            </li>
                                                            <li>
                                                ...
                                                <li class="item col-md-4 html">
                                                    ...
                                                    <div class="menu-content">
                                                        <ul>
                                                            <li>
                                                                <a href="index.php?action=404">404 Page</a>
                                                            </li>
                                                            <li>
                                                                <a href="index.php?action=about-us">About Us Page</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
                        ...
                        <li class="item has-sub">
                            <a href="index.php?action=contact" title="Contact us">

<div>
    ...
    <body id="contact" class="blog body">
        <!-- main content -->
                                ...
                                <div class="row-inhert">
                                                ...
                                                <div class="item d-flex">
                                                    ...
                                                    <div class="item-right d-flex">
                                                        ...
                                                        <div class="contact-content">
                                                            <a href="index.php?action=mailto:support@domain.com">support@domain.com</a>
                                                            <br>
                                                            <a href="index.php?action=mailto:contact@domain.com">contact@domain.com</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="input-contact">
                                        ...
                                        <p class="icon text-center">
                                            <a href="#">
                                                <img src="General/img/other/contact_mess.png" alt="img">
                                            </a>
                                        </p>
                                                    ...
                                                    <form action="#" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <button class="btn" type="submit" name="submitMessage">
                                                                <img class="img-fl" src="General/img/other/contact_email.png" alt="img">Send message
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
